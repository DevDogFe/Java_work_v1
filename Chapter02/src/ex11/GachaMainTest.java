...
public class GachaMainTest {
	...
	public static void main(String[] args) {
		...
		while (flag) {
			...
			if (userChoice == COIN) {
				...
				game(count, sc, gachaMachine, gameFlag, userChoice);
				if (gameFlag == false) {
					continue;
				}
				gacha(gachaMachine, goods);
	...
	static void game(int count, Scanner sc, GachaMachine gachaMachine, boolean gameFlag, int userChoice) {
	...
	static void gacha(GachaMachine gachaMachine, Goods[] goods) {
